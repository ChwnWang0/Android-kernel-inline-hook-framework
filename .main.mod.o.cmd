cmd_/mnt/driver/main.mod.o := clang -Wp,-MMD,/mnt/driver/.main.mod.o.d -nostdinc -isystem /opt/ddk/clang/clang-r416183b/lib64/clang/12.0.5/include -I/opt/ddk/src/android12-5.10/arch/arm64/include -I./arch/arm64/include/generated -I/opt/ddk/src/android12-5.10/include -I./include -I/opt/ddk/src/android12-5.10/arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I/opt/ddk/src/android12-5.10/include/uapi -I./include/generated/uapi -include /opt/ddk/src/android12-5.10/include/linux/kconfig.h -include /opt/ddk/src/android12-5.10/include/linux/compiler_types.h -D__KERNEL__ --target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -fintegrated-as -Werror=unknown-warning-option -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -Qunused-arguments -fmacro-prefix-map=/opt/ddk/src/android12-5.10/= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -mgeneral-regs-only -DCONFIG_CC_HAS_K_CONSTRAINT=1 -Wno-psabi -fno-asynchronous-unwind-tables -fno-unwind-tables -mbranch-protection=pac-ret+leaf+bti -Wa,-march=armv8.5-a -DARM64_ASM_ARCH='"armv8.5-a"' -ffixed-x18 -DKASAN_SHADOW_SCALE_SHIFT= -fno-delete-null-pointer-checks -Wno-frame-address -Wno-address-of-packed-member -O2 -Wframe-larger-than=2048 -fstack-protector-strong -Werror -Wno-format-invalid-specifier -Wno-gnu -mno-global-merge -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -ftrivial-auto-var-init=zero -enable-trivial-auto-var-init-zero-knowing-it-will-be-removed-from-clang -g -gdwarf-4 -fsanitize=shadow-call-stack -flto -fvisibility=default -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-array-bounds -fno-strict-overflow -fno-stack-check -Werror=date-time -Werror=incompatible-pointer-types -fno-builtin-wcslen -Wno-initializer-overrides -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-pointer-to-enum-cast -Wno-tautological-constant-out-of-range-compare -Wno-enum-compare-conditional -fsanitize=array-bounds -fsanitize=local-bounds -fsanitize-undefined-trap-on-error -DMODULE -DKBUILD_BASENAME='"main.mod"' -DKBUILD_MODNAME='"main"' -D__KBUILD_MODNAME=kmod_main -c -o /mnt/driver/main.mod.o /mnt/driver/main.mod.c

source_/mnt/driver/main.mod.o := /mnt/driver/main.mod.c

deps_/mnt/driver/main.mod.o := \
  ...
  /opt/ddk/src/android12-5.10/include/linux/build-salt.h \
    $(wildcard include/config/build/salt.h) \
  /opt/ddk/src/android12-5.10/include/linux/elfnote.h \
  /opt/ddk/src/android12-5.10/include/linux/vermagic.h \
  include/generated/utsrelease.h \
  /opt/ddk/src/android12-5.10/arch/arm64/include/asm/vermagic.h \

/mnt/driver/main.mod.o: $(deps_/mnt/driver/main.mod.o)
